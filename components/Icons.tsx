...
export const BeakerIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M14.25 8.25h-4.5" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 5.25a.75.75 0 01.75-.75h3a.75.75 0 01.75.75v.01a.75.75 0 01-.75.75h-3a.75.75 0 01-.75-.75V5.25z" />
  </svg>
);
...
export const CalculatorIcon: React.FC<IconProps> = ({ className = 'w-6 h-6', strokeWidth = 2 }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={strokeWidth}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 7h6m-6 4h6m-6 4h6m2 2H7a2 2 0 01-2-2V7a2 2 0 012-2h10a2 2 0 012 2v8a2 2 0 01-2 2z" />
    </svg>
);
